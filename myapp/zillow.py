        ...
        try:
            for card in deck.contents:
                ...
                if script:
                        ...
                        d1 = script_json['geo']['latitude']
                        d2 = script_json['geo']['longitude']
                        d3= script_json['floorSize']['value']
                        d4 = script_json['url']
                        d5 = card.find('div', {'class': 'list-card-price'}).text
        except:
            pass
    print(d1)        